...
"[project]/.next-internal/server/app/api/files/[...path]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/files/[...path]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request, { params }) {
    ...
    try {
        ...
        if (stats.isDirectory()) {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].rmdir(fullPath, {
                recursive: true
            });
        } else {
...
async function GET(request, { params }) {
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            name: __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(fullPath),
            path: relativePath,
            content
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c022e47._.js.map