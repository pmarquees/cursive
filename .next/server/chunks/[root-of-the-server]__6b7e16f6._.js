...
"[project]/.next-internal/server/app/api/files/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
async function GET(request) {
    try {
        ...
        const fullPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(WORKSPACE_DIR, dirPath);
        ...
        const fileList = await Promise.all(items.map(async (item)=>{
            const itemPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(fullPath, item.name);
            const relativePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].relative(WORKSPACE_DIR, itemPath);
            if (item.isDirectory()) {
                return {
                    name: item.name,
                    type: 'directory',
                ...
                const content = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(itemPath, 'utf-8');
                return {
                    name: item.name,
                    type: 'file',
                    path: relativePath,
...
async function POST(request) {
    try {
        ...
        const fullPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(WORKSPACE_DIR, filePath, name);
        // Security check
        if (!fullPath.startsWith(WORKSPACE_DIR)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid path'
        ...
        if (type === 'directory') {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].mkdir(fullPath, {
                recursive: true
            });
        } else {
        ...
        const relativePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].relative(WORKSPACE_DIR, fullPath);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            file: {
                name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b7e16f6._.js.map